...
LastEditTime: 2021-08-09 20:22:32
LastEditors: Please set LastEditors
Description: In User Settings Edit
FilePath: /molecular_representation/layers.py
'''
...
class Embeddings(nn.Module):
    """Construct the embeddings from molecules, position embeddings.
    """
